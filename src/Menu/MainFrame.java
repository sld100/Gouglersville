...
public class MainFrame extends javax.swing.JFrame {
    ...
    //TODO change to declaration only
Reports RP;
Inventory INTRY;
Depleted DPT;
//TODO declare class level connection item
...
public void connectMenu()
    ...
    try {
        ...
        String DBName = "F:\\Gouglersville (Unzipped Files)\\Gouglersville\\src\\Menu\\GouglersvilleMenu.db"; //F:\\Gouglersville (Unzipped Files)\\Gouglersville\\src\\Menu\\GouglersvilleMenu.db";
    ...
    public MainFrame() {
        initComponents();
        connectMenu();
        RP = new Reports(connect);
        INTRY = new Inventory(connect);
        DPT = new Depleted(connect);
    }
